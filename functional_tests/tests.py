...
class NewVisitorTest(LiveServerTestCase):
    ...
    def wait_for_row_in_list_table(self, row_text):
        ...
        while True:
            try:
                ...
                return
            except (AssertionError, WebDriverException) as _except:
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        self.assertNotIn('Make the fly of peacock feathers', page_text)
        ...
        self.assertNotEqual(frencis_list_url, edith_list_url)
